...
use Vmj\VmjBundle\Entity\Media;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $media = $em->getRepository('VmjBundle:Media')->findAll();
    ...
    {
        $medium = new Media();
        $form = $this->createForm('Vmj\VmjBundle\Form\MediaType', $medium);
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('Vmj\VmjBundle\Form\MediaType', $medium);
