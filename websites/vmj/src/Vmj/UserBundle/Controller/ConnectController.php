...
class ConnectController extends Controller
{
    ...
    public function registrationAction(Request $request, $key)
    {
        ...
        if($request->get('fos_user_registration_form')['user_profile']['type']){
            $birthday = \DateTime::createFromFormat("d-m-Y",$request->get('fos_user_registration_form')['user_profile']['birthday']);
            $all = $request->request->all();
            $birthday->format('Y-m-d');
            $all['fos_user_registration_form']['user_profile']['birthday'] = $birthday;
